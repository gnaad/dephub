package com.dephub.android.common;
...
public class Snippet {
    ...
    public static void fetchDependency(String dependencyType, Context context, JSONArray response, ArrayList<CardModel> cardText, ProgressDialog progressDialog) {
        for (int i = 0; i < response.length(); i++) {
            try {
                ...
                if (type.equals(dependencyType)) {
                    ...
                    String bg = context.getString(R.color.whitetoblack);
    ...
    public static void openWeb(Context context, CardModel model) {
