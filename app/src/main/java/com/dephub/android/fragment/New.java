...
public class New extends Fragment {
    public static final String url = "https://gnanendraprasadp.github.io/DepHub-Web/json/leaderboardfollowedbynew.json";
    private RecyclerView cardrecyclerviewnew;
    private Cardadapter cardviewadapternew;
    private ArrayList<Cardmodel> cardnew;
    ...
    public View onCreateView(LayoutInflater inflater,ViewGroup container,Bundle savedInstanceState) {
        ...
        cardrecyclerviewnew = view.findViewById(R.id.newfragment);
        setRetainInstance(true);

        cardnew = new ArrayList<>( );
            ...
            public void onResponse(JSONArray response) {
                for (int i = 0; i < response.length( ); i++) {
                    ...
                    try {
                        ...
                        cardnew.add(new Cardmodel(depname,devname,gitlink,bg,youtube,id,license,licenselink,fullname));

                        Collections.sort(cardnew,new Comparator<Cardmodel>( ) {
                            @Override
    ...
    private void buildcardview() {
        cardviewadapternew = new Cardadapter(cardnew,getActivity( ));
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getContext( ));
        cardrecyclerviewnew.setHasFixedSize(true);
        cardrecyclerviewnew.setLayoutManager(linearLayoutManager);
        cardrecyclerviewnew.setAdapter(cardviewadapternew);
    }
}