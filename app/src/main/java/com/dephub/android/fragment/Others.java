...
public class Others extends Fragment {
    public static final String url = "https://gnanendraprasadp.github.io/DepHub-Web/json/fragmentfollowedbyothers.json";
    private RecyclerView cardrecyclerviewuncategorised;
    private Cardadapter cardviewadapteruncategorised;
    private ArrayList<Cardmodel> carduncategorised;
    ...
    public View onCreateView(LayoutInflater inflater,ViewGroup container,Bundle savedInstanceState) {
        ...
        cardrecyclerviewuncategorised = view.findViewById(R.id.uncategorisedfragment);

        carduncategorised = new ArrayList<>( );
            ...
            public void onResponse(JSONArray response) {
                for (int i = 0; i < response.length( ); i++) {
                    ...
                    try {
                        ...
                        carduncategorised.add(new Cardmodel(depname,devname,gitlink,bg,youtube,id,license,licenselink,fullname));

                        Collections.sort(carduncategorised,new Comparator<Cardmodel>( ) {
                            @Override
    ...
    private void buildcardview() {
        cardviewadapteruncategorised = new Cardadapter(carduncategorised,getActivity( ));
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getContext( ));
        cardrecyclerviewuncategorised.setHasFixedSize(true);
        cardrecyclerviewuncategorised.setLayoutManager(linearLayoutManager);
        cardrecyclerviewuncategorised.setAdapter(cardviewadapteruncategorised);
    }
}