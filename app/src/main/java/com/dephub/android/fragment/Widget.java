...
public class Widget extends Fragment {
    ...
    private ArrayList<DependencyModel> cardWidget;
    private SwipeRefreshLayout swipeRefreshLayout;
    LinearLayoutManager linearLayoutManager;
    private DependencyAdapter cardViewAdapterWidget;
    ...
    private void buildCardView() {
        cardViewAdapterWidget = new DependencyAdapter(cardWidget, getActivity());
