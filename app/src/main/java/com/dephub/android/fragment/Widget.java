...
public class Widget extends Fragment {
                ...
                for (int i = 0; i < response.length(); i++) {
                    ...
                    try {
                        ...
                        if (type.equals("Widget")) {
                            ...
                            cardWidget.add(new CardModel(dependencyName, developerName, githubLink, bg, youtube, id, license, licenseLink, fullName));
    ...
    private void buildCardView() {
        CardAdapter cardViewAdapterWidget = new CardAdapter(cardWidget, getActivity());
